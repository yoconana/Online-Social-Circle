...
$deleteactivityUserid = $_POST['deleteuserid'];
?>
...
<?php
	...
	$queryString = "DELETE
		...
		WHERE USERID = $deleteactivityUserid
		AND ACTIVITYID = $activityId";
	if(mysql_query($queryString,$db)){
		echo 'Deleted! Go back to the <a href="activitydetails.php?activityid='.$activityId.'">activity page</a>.';
	}
	else{
